...
export function Icon({ name }: { name: IconName }) {
  switch (name) {
    ...
    case 'paperclip':
      return (
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path d="m21.5 11.5-9.5 9.5a7 7 0 0 1-9.9-9.9l9.2-9.2a4.5 4.5 0 0 1 6.4 6.4l-9.2 9.2a2 2 0 0 1-2.8-2.8l8.5-8.5" />
        </svg>
      )
    case 'settings':
      return (
    ...
    case 'wand':
      return (
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path d="m15 4-1 2-2 1 2 1 1 2 1-2 2-1-2-1-1-2ZM3 17l9.5-9.5M16 9l3 3-9 9-3-3 9-9Z" />
        </svg>
      )
    case 'cpu':
      return (
        <svg viewBox="0 0 24 24" aria-hidden="true">
          ...
          <rect height="4" rx="0.5" width="4" x="10" y="10" />
        </svg>
      )
  }
}
